...
public interface PcCurrentDao {
	...
	public Map<String, Object> selectamt(Map<String, Object> paramMap) throws Exception;

	public void userPaymentPc(Map<String, Object> paramMap) throws Exception;

	public void userPaymentOrder(Map<String, Object> paramMap) throws Exception;
